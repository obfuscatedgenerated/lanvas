...
const FloatingCommentControl = ({comments_on_canvas, setCommentsOnCanvas}: FloatingCommentControlProps) => {
    ...
    return (
        <details className="group font-sans text-sm fixed bottom-4 left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-4 bg-neutral-900/70 backdrop-blur-sm border border-neutral-800/70 rounded-lg p-4 max-w-[95vw] sm:max-w-md w-full space-y-2">
